...
#turn encoded_matrix into a 3D cloud of points
 # row i, column j, relative depth. (x,y,z) coordinate system. Point3D = (x,y,z) with color 0xRRGGBB. 
 # points_xyz = (N,3) array, each row will be (x,y,z). colors_rgb = (N,3) array, each row will be (R, G, B). normalized to 255. 
 # Output points_xyz, colors_rgb.

def cloud(encoding_matrix):
